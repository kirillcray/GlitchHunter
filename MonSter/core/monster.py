...
# Добавляем абсолютный путь к Depth-Anything-V2-list3
...
class Monster(nn.Module):
    def __init__(self, args):
        ...
        state_dict_dpt = torch.load(r'C:/Users/e.a.kurochkina/dev/def_map/MonSter/pretrained/depth_anything_v2_vitl.pth', map_location='cpu')
